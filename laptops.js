...
const LAPTOP_CATALOG = [
...

  {
    ...
    modelCode: 'Legion 5 15AKP10 retail configuration',
...

  {
    ...
    tier: 'mid-range',
    badge: 'Current AMD Platform Pick',
    gpu: 'RTX 5070',
    gpuVram: '8GB GDDR7',
    tgp: 115,
    cpu: 'AMD Ryzen 9 270',
    ...
    modelCode: 'TUF A16 2025 retail configuration',
...

  {
    ...
    brand: 'Lenovo',
    name: 'Legion 5 Gen 10 (32GB)',
    shortName: 'Legion 5 OLED 32GB',
    tier: 'mid-range',
    badge: 'New 2026 Review',
    status: 'evidence-review',
    gpu: 'RTX 5060',
    ...
    ramUpgradeable: true,
    storage: '1TB PCIe Gen4 NVMe',
    display: { size: 15.1, res: '2560×1600', hz: 165, panel: 'OLED', nits: 500, hdr: 'HDR True Black 600' },
    weight: 1.9,
    battery: 80,
    price: 2099,
    score: null,
    scores: null,
    bestFor: 'OLED gaming, upgradeable memory, and a current RTX 5060 platform',
    avoidIf: 'You need RTX 5070-class performance or a larger 16-inch chassis',
    amazonUrl: 'https://www.amazon.com/dp/B0FVKMHCLS?tag=framelimit20-20',
    amazonAsin: 'B0FVKMHCLS',
    modelCode: 'Legion 5 15AHP10 retail 32GB configuration',
    specSource: 'https://psref.lenovo.com/Product/Legion/Legion_5_15AHP10',
    specCheckedAt: '2026-07-15',
    imgUrl: 'images/laptops/lenovo-legion-5-amd.webp',
    imgBg: '#090d11',
    tags: ['15-inch', 'nvidia', 'amd-cpu', 'oled', 'mid-range', 'evidence-review'],
  },
