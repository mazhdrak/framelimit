...
function flReviewLink(id) {
  const map = {
    ...
    'alienware-18-area-51':             'review-alienware-18-area-51',
    'dell-alienware-16x-aurora':        'review-alienware-16x-aurora',
    'hp-omen-max-16-2026':              'review-hp-omen-max-16-2026',
    'hp-omen-16-rtx5070-2026':          'review-notes-2026#hp-omen-16-rtx5070-2026',
