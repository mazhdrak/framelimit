...
const expected = {1000: ['hp-victus-15-fa1040nr'], 1500: ['gigabyte-gaming-a16-rtx5060', 'acer-nitro-v-16'], 2000: ['gigabyte-gaming-a16-rtx5060', 'acer-nitro-v-16', 'gigabyte-a16-cwhi3us864sh', 'msi-vector-a2xwhg-212us'], 2500: ['msi-katana-15-hx', 'dell-alienware-16x-aurora'], 3000: ['msi-vector-16-hx-ai']};
for (const [budget, ids] of Object.entries(expected)) {
  ...
  assert.ok(!/\$(?:949\.99|1,546\.99|1,657\.99|1,299\.97|1,449\.99|2,272\.69|2,399|2,759|3,589|3,699\.95)/.test(html), budget);
}
