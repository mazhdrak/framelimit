    ...
    if (l.imgUrl) {
      ...
      if (imgWrap) {
        ...
        if (img) {
          ...
          img.alt = l.name;
          img.loading = 'lazy';
          img.style.cssText = 'width:100%;height:100%;object-fit:contain;padding:20px;display:block';
          imgWrap.insertBefore(img, imgWrap.firstChild);
        }
        imgWrap.style.background = '#080A0C';
      }
    }
    ...
    if (ctaRow && !ctaRow.querySelector('.fl-review-injected')) {
      const reviewUrl = (function() {
        const map = {
          ...
          'asus-rog-zephyrus-g16-2026':'g16','asus-rog-zephyrus-g14-2026':'g14',
