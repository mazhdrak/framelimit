...
- [ ] Свързване на individual reviews с подходящия price guide.
  ...
  - [x] `scripts/audit-internal-links.mjs` вече валидира 24 двупосочни content clusters в 51 уникални cluster файла и блокира generic `Full Review`, `Read Full Review`, `Read Review` и `Read more` anchors.
