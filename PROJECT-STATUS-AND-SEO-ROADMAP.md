...
- [ ] Свързване на individual reviews с подходящия price guide.
  ...
  - [x] `scripts/audit-internal-links.mjs` вече валидира 19 двупосочни content clusters в 46 уникални cluster файла и блокира generic `Full Review`, `Read Full Review`, `Read Review` и `Read more` anchors.
