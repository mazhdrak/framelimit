...
- Removed hard-coded review-count claims from the hub so the copy cannot drift from the actual catalog. Cache versions are `style.css?v=20260911-1` on the Reviews hub and `laptops.js?v=20260911-2` across pages that hydrate catalog content.
